...
const translations: Record<Language, Translations> = {
  fr: {
    ...
    "sidebar.cv": "Télécharger mon CV",
    "sidebar.github": "Voir mon GitHub",
    ...
    "home.greeting": "Bonjour ! Je suis **Malek LE VELLY**, développeur passionné. 👋\n\n⚠️ **Petit conseil** : Ce n'est pas ChatGPT, mais un **portfolio interactif** !\n\nTapez des mots-clés (ex: \"formation\", \"langages\") ou explorez toutes les questions via le bouton **[+]** pour découvrir mon parcours.\n\nBonne visite ! 🚀",
  ...
  en: {
    ...
    "sidebar.linkedin": "LinkedIn",
    "sidebar.cv": "Download my resume",
    "sidebar.github": "View my GitHub",
    "sidebar.animations": "Animations",
    ...
    "home.greeting": "Hello! I'm **Malek LE VELLY**, a passionate developer. 👋\n\n⚠️ **Quick tip**: This isn't ChatGPT, but an **interactive portfolio**!\n\nType keywords (e.g., \"education\", \"languages\") or explore all questions via the **[+]** button to discover my journey.\n\nEnjoy your visit! 🚀",
