...
// Ce fichier sert de point d'entrée centralisé pour tous les composants interactifs
// Quand vous créez un nouveau composant, ajoutez-le ici
...
export { default as ApplicationsGrid } from "./ApplicationsGrid"