          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="px-4 pt-4 pb-3">
              <input
                ...
                className="question-browser-input w-full rounded-lg bg-green-moss px-4 py-2.5 outline-none transition-all text-green-light placeholder-green font-medium"
                autoFocus
              />
            </div>
